...
public class TimeUtil {
    ...
    public static String getDate(){
        ...
        Log.d("miaotime","year="+year+".....month="+month+".....day="+day+".....hour="+hours+".....min="+mins);
        Log.d("miaotime","当前时间毫秒数：" + calendar.getTimeInMillis());
        Log.d("miaotime","currenmill：" + System.currentTimeMillis());
        return "";
    }
